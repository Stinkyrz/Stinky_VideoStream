...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/Stinkyrz'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/Stinkyrz/Stinky_VideoStream')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/Stinkyrz/Stinky_VideoStream'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/Stinkyrz'),     
        ],
        [
